...
use App\Http\Livewire\Clients\ClientsController;
...
Route::get('/wp/ordersprocess/simco/portal', [OrderFromPortalCotroller::class, 'getQRFromSimCoPortal']);
...
Route::get('infophp', function() { phpinfo(); });
...
Route::webhooks('webhook/simco', 'simco');
Route::webhooks('webhook/mercadolibre', 'mercadolibre');
